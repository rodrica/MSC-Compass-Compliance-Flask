...
def check_user_claims(data: dict, default_tenant_id: UUID):
...
class Users(MethodView):
    ...
    def post(self, data: dict):
        ...
        user = User(
            ...
            claims_by_audience=check_user_claims(data, current_user.tenant_id),
            tags=data.get('tags'),
            roles=roles,
...
class UserById(MethodView):
    ...
    def put(self, data: dict, user_id: str):
        ...
        user.claims_by_audience = check_user_claims(data, current_user.tenant_id)
