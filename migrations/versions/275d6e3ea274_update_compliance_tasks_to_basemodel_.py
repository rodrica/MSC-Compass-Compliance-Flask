"""Update compliance_tasks to BaseModel structure

Revision ID: 275d6e3ea274
Revises: 30dafd52462f
Create Date: 2022-02-24 14:33:19.398930
...
revision = '275d6e3ea274'
down_revision = '30dafd52462f'
branch_labels = None
depends_on = None


def upgrade():
    with op.batch_alter_table("compliance_tasks", "public") as t:
        t.alter_column("name", new_column_name="description")
        t.alter_column("short_name", new_column_name="name")
...
def downgrade():
    with op.batch_alter_table("compliance_tasks", "public") as t:
        t.alter_column("name", new_column_name="short_name")
        t.alter_column("description", new_column_name="name")
        t.drop_column("tags")
